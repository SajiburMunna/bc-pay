...
const Modal = ({
  ...
  return ReactDOM.createPortal(
    <div
      className="fixed inset-0 z-[999] grid h-screen w-screen place-items-center bg-[#3f3f3f34] transition-opacity duration-300"
      onClick={onClose}
    >
      <motion.div
...
const ModalHeader = ({
  ...
  <div className={cn("font-semibold text-black text-lg mb-2", className)}>
    {children}
  </div>
);
